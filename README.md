...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/aML2Gbyk0A)
...
```sh
npx nx serve form-app
```

To create a production bundle:

```sh
npx nx build form-app
```

To see all available targets to run for a project, run:

```sh
npx nx show project form-app
```
